...
#include <iostream>
#include <unistd.h>
#include "ggml.cpp/examples/gpt-2/main.cpp"
...
void* gpt2_allocate_state() {
    return new gpt2_state;
}

void gpt2_free_model(void *state_ptr) {
    gpt2_state* state = (gpt2_state*) state_ptr;
...
void* gpt2_allocate_params(const char *prompt, int seed, int threads, int tokens, int top_k,
