...
CFLAGS   = -I. -I./ggml.cpp/include/ggml/ -I./ggml.cpp/examples/ -I -O3 -DNDEBUG -std=c11 -fPIC
CXXFLAGS = -I. -I./ggml.cpp/include/ggml/ -I./ggml.cpp/examples/ -O3 -DNDEBUG -std=c++17 -fPIC
LDFLAGS  =
...
libgpt2.a: stablelm.o redpajama.o gpt2.o ggml.o dolly.o common-ggml.o common.o
	ar src libgpt2.a stablelm.o redpajama.o gpt2.o dolly.o ggml.o common-ggml.o common.o
